...
@section('main_content')
                ...
                <tbody>
                    @foreach ($fertilizers as $key => $fertilizer)
                        <tr>
                            ...
                            <td class="text-center">{{ $fertilizer->name }}
                            </td>
                            <td class="text-center"><a class="btn-sm btn-success text-white" data-toggle="modal"
                                ...
                                {{-- modal for adding fertilizer status --}}
                                <div class="modal fade text-sm" id="modal-lg{{$key+1}}">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="">{{ __('मल सच्याउनुहोस् ') }}</h5>
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="{{ route('fertilizer.update',$fertilizer) }}">
                                                    @method('PUT')
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text" value="{{ $fertilizer->name }}" name="name"
                                ...
                                {{-- end of modal for adding fertilizer status --}}
                            </td>
                        </tr>
                    @endforeach
            </table>
    ...
    <div class="modal fade text-sm" id="modal-lg">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="">{{ __('मल थप्नुहोस') }}</h5>
                    <button type=" button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="post" action="{{ route('fertilizer.store') }}">
                        @csrf
                        <div class="row">
                            <div class="col-6">
                                <div class="input-group input-group-sm">
