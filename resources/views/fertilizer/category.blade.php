...
@section('main_content')
        ...
        <div class="card-header my-2">
            <div class="row my-1">
                <div class="col-md-6" style="margin-bottom:-5px;">
                    <p class="">{{ __('Category: वर्गको सुचिहरु') }}</p>
                </div>
                <div class="
                        col-md-6 text-right">
                    <a class="btn text-white btn-sm btn-primary" data-toggle="modal" data-target="#modal-lg">
                        <i class="fas fa-plus px-2"></i> {{ __('Category: (वर्ग) थप्नुहोस') }}</a>
                </div>
            </div>
        </div>
        <!-- /.card-header -->
            ...
            <table id="example1" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">{{ __('Category: (वर्ग)') }}</th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="">{{ __('Category: (वर्ग) सच्याउनुहोस् ') }}</h5>
                                                            ...
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                @error('name')
                                                                    <p class="invalid-feedback mb-0" style="font-size: 0.9rem">
                                                                        {{ __('Category: (वर्ग)को फिल्ड खाली छ ') }}
                                                                    </p>
                                                                @enderror
                                                            </div>
                                                        </div>
    ...
    <div class="modal fade text-sm" id="modal-lg">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="">{{ __('Category: (वर्ग) थप्नुहोस') }}</h5>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="input-group input-group-sm">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                            {{ __('Category: (वर्ग)') }} <span class="text-danger px-1 font-weight-bold">*</span>
                                        </span>
                                    </div>
