...
<div class="row" id="app" style="width: 100%;">
    ...
    <input v-model="po_id" type="hidden" id="province_id" name="permanent_province_id">
    <input v-model="di_id" type="hidden" id="district_id" name="permanent_district_id">
    <input v-model="mun_id" type="hidden" id="municipality_id" name="permanent_municipality_id">
</div>
