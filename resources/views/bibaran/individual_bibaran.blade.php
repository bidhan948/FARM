    ...
    <div class="card text-sm ">
        ...
        <div class="card-body" id="app">
            <div class="row">
                ...
                @else
                    <div class="col-lg-3 col-4">
                        ...
                        <div class="small-box bg-info">
                            ...
                            <a href="{{route('land_detail_show',$land_owner)}}" class="small-box-footer">{{ __('हेर्नुहोस्') }} <i
                ...
                @if ($land_owner->facilityDetail->count() == 0)
                    <div class="col-lg-3 col-4">
                        <!-- small box -->
                        <div class="small-box bg-info">
                            <div class="inner text-center">
                                <p><i class="fas fa-plus px-2"></i> {{ __('सरकारी तथा गैरसरकारी विवरण भर्नुहोस्') }}</p>
                            </div>
                            <div class="icon">
                            </div>
                            <a href="{{ route('facility_detail_add', $land_owner) }}"
                                class="small-box-footer">{{ __('भर्नुहोस्') }} <i class="px-1 fas fa-plus"></i></a>
                        </div>
                    </div>
                @else
                    <div class="col-lg-3 col-4">
                        ...
                        <div class="small-box bg-info">
                            <div class="inner text-center">
                                <p><i class="fas fa-eye px-2"></i> {{ __('सरकारी तथा गैरसरकारी विवरण हेर्नुहोस') }}</p>
                            </div>
                            <div class="icon">
                            </div>
                ...
                @if ($land_owner->samuhaOrganizationDetail->count() == 0)
                    <div class="col-lg-3 col-4">
                        <!-- small box -->
                        <div class="small-box bg-info">
                            <div class="inner text-center">
                                <p><i class="fas fa-plus px-2"></i> {{ __('समूह / सहकारी / फारम विवरण भर्नुहोस्') }}</p>
                            </div>
                            <div class="icon">
                            </div>
