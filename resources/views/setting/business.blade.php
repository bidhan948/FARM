...
@section('title', 'व्यबसाय')
@section('menu_open', 'menu-open')
@section('s_child', 'block')
@section('setting_business', 'active')
@section('main_content')
        ...
        <div class="card-header my-2">
            <div class="row my-1">
                <div class="col-md-6" style="margin-bottom:-5px;">
                    <p class="">{{ __('व्यबसायको सुचिहरु') }}</p>
                </div>
                <div class="
                        col-md-6 text-right">
                    <a class="btn text-white btn-sm btn-primary" data-toggle="modal" data-target="#modal-lg">
                      <i class="fas fa-plus-circle px-1"></i>  {{ __('व्यबसाय थप्नुहोस') }}</a>
                </div>
            </div>
        </div>
        <!-- /.card-header -->
            ...
            <table id="example1" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">{{ __('व्यबसाय') }}</th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($businesses as $key => $business)
                        <tr>
                            ...
                            <td class="text-center">{{ $business->name }}
                            </td>
                            <td class="text-center"><a class="btn-sm btn-success text-white" data-toggle="modal"
                                ...
                                {{-- modal for adding business status --}}
                                <div class="modal fade text-sm" id="modal-lg{{$key+1}}">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="">{{ __('व्यबसाय सच्याउनुहोस् ') }}</h5>
                                ...
                                {{-- end of modal for adding business status --}}
                            </td>
                        </tr>
                    @endforeach
            </table>
    ...
    <div class="modal fade text-sm" id="modal-lg">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="">{{ __('व्यबसाय थप्नुहोस') }}</h5>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="input-group input-group-sm">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                            {{ __('व्यबसाय') }} <span class="text-danger px-1 font-weight-bold">*</span>
                                        </span>
                                    </div>
