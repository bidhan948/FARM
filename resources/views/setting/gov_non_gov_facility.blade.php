...
@section('main_content')
            ...
            <table id="example1" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">{{ __('सुबिधा') }}</th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($facilities as $key => $facility)
                        <tr>
                            ...
                            <td class="text-center">{{ $facility->name }}
                            </td>
                            <td class="text-center"><a class="btn-sm btn-success text-white" data-toggle="modal"
                                ...
                                {{-- modal for adding facility status --}}
                                <div class="modal fade text-sm" id="modal-lg{{$key+1}}">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="">{{ __('सुबिधा सच्याउनुहोस् ') }}</h5>
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="{{ route('facility.update',$facility) }}">
                                                    @method('PUT')
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text" value="{{ $facility->name }}" name="name"
                                                                    class="form-control  @error('name') is-invalid @enderror">
                                                                @error('name')
                                                                    <p class="invalid-feedback mb-0" style="font-size: 0.9rem">
                                                                        {{ __('सुबिधाको फिल्ड खाली छ ') }}
                                                                    </p>
                                                                @enderror
                                                            </div>
                                                        </div>
                                ...
                                {{-- end of modal for adding facility status --}}
                            </td>
                        </tr>
                    @endforeach
            </table>
    ...
    <div class="modal fade text-sm" id="modal-lg">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="">{{ __('सुबिधा थप्नुहोस') }}</h5>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="input-group input-group-sm">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                            {{ __('सुबिधा') }} <span class="text-danger px-1 font-weight-bold">*</span>
                                        </span>
                                    </div>
