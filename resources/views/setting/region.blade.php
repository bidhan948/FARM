...
@section('title', 'क्षेत्र')
@section('menu_open', 'menu-open')
@section('s_child', 'block')
@section('setting_region', 'active')
@section('main_content')
            ...
            <table id="example1" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">{{ __('क्षेत्र') }}</th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($regions as $key => $region)
                        <tr>
                            ...
                            <td class="text-center">{{ $region->name }}
                            </td>
                            <td class="text-center"><a class="btn-sm btn-success text-white" data-toggle="modal"
                                ...
                                {{-- modal for adding region status --}}
                                <div class="modal fade text-sm" id="modal-lg{{$key+1}}">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="">{{ __('क्षेत्र सच्याउनुहोस् ') }}</h5>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text" value="{{ $region->name }}" name="name"
                                                                    class="form-control  @error('name') is-invalid @enderror">
                                                                @error('name')
                                                                    <p class="invalid-feedback mb-0" style="font-size: 0.9rem">
                                                                        {{ __('क्षेत्रको फिल्ड खाली छ ') }}
                                                                    </p>
                                                                @enderror
                                                            </div>
                                                        </div>
                                ...
                                {{-- end of modal for adding region status --}}
                            </td>
                        </tr>
                    @endforeach
            </table>
    ...
    <div class="modal fade text-sm" id="modal-lg">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="">{{ __('क्षेत्र थप्नुहोस') }}</h5>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="input-group input-group-sm">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                            {{ __('क्षेत्र') }} <span class="text-danger px-1 font-weight-bold">*</span>
                                        </span>
                                    </div>
