...
@section('title', 'बलिको प्रकार')
@section('menu_open', 'menu-open')
@section('s_child', 'block')
@section('setting_crop_type', 'active')
                    ...
                    @foreach ($crop_types as $key => $crop_type)
                        <tr>
                            ...
                            <td class="text-center"><a class="btn-sm btn-success text-white" data-toggle="modal"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text" value="{{ $crop_type->name }}" name="name"
                                ...
                                {{-- end of modal for adding crop_type status --}}
                            </td>
                        </tr>
                    @endforeach
            </table>
